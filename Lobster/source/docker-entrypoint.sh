...
aws s3 cp result_hd01_baseline.txt s3://sok-repository-eval-benchmarks
...
aws s3 cp result_hd01_lobster.txt s3://sok-repository-eval-benchmarks

# homomorphically evaluate 'hd01'
../homomorphic_evaluation/mc_parser/he_base test.eqn 1 > result_test_eval.txt
aws s3 cp result_test_eval.txt s3://sok-repository-eval-benchmarks
